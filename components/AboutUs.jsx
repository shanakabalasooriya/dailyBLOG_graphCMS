...
const AboutUs = () => {
  return (
    <div className=' bg-white shadow-lg rounded-lg p-8 mb-8 items-center justify-center'>
      ...
      <p className='mx-1 text-center'>Every business has a story to tell. Even if you're running a start-up, you might not have a long history of changes and growth (yet), but it's a nice touch to talk about how you got to where you are on the About page..</p>
